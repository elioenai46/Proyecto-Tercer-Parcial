...
Descripción: JFrame AvataresX, JFrame donde el jugadorx selecciona su avatar
y recibimos el nombre del jugador x, despues nos iremos a la clase JugadorO.
 */
package Pojo;
...
public class AvataresX extends javax.swing.JFrame {
    ...
    /*
        ...
        las clases.
     */
    public static ImageIcon iconox;

    public AvataresX(String jugadorx) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 30, 180, 60));

        Fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Media/Este si.jpg"))); // NOI18N
        jPanel1.add(Fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1010, 600));
    ...
    /*
        ...
        Avatar, se hace una instancia a la siguiente clase (JugadorO) y le 
        enviamos el nombre del jugador x y su icono.
     */
    private void Avatar6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Avatar6ActionPerformed
        iconox = new ImageIcon("/home/labso04/Vídeos/respaldo/ParadigmasDeProgramacion/src/Media/6.png");
        JugadorO salto = new JugadorO(jugadorx, iconox);
    ...
    private void Avatar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Avatar1ActionPerformed
        iconox = new ImageIcon("/home/labso04/Vídeos/respaldo/ParadigmasDeProgramacion/src/Media/1.png");
        JugadorO salto = new JugadorO(jugadorx, iconox);
        salto.setVisible(true);
        this.hide();
    ...
    private void Avatar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Avatar2ActionPerformed
        iconox = new ImageIcon("/home/labso04/Vídeos/respaldo/ParadigmasDeProgramacion/src/Media/2.png");
        JugadorO salto = new JugadorO(jugadorx, iconox);
        salto.setVisible(true);
        this.hide();
    ...
    private void Avatar3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Avatar3ActionPerformed
        iconox = new ImageIcon("/home/labso04/Vídeos/respaldo/ParadigmasDeProgramacion/src/Media/3.png");
        JugadorO salto = new JugadorO(jugadorx, iconox);
        salto.setVisible(true);
        this.hide();
    ...
    private void Avatar4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Avatar4ActionPerformed
        iconox = new ImageIcon("/home/labso04/Vídeos/respaldo/ParadigmasDeProgramacion/src/Media/4.png");
        JugadorO salto = new JugadorO(jugadorx, iconox);
        salto.setVisible(true);
        this.hide();
    ...
    private void Avatar5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Avatar5ActionPerformed
        iconox = new ImageIcon("/home/labso04/Vídeos/respaldo/ParadigmasDeProgramacion/src/Media/5.png");
        JugadorO salto = new JugadorO(jugadorx, iconox);
        salto.setVisible(true);
        this.hide();
    ...
    private void Avatar7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Avatar7ActionPerformed
        iconox = new ImageIcon("/home/labso04/Vídeos/respaldo/ParadigmasDeProgramacion/src/Media/7.png");
        JugadorO salto = new JugadorO(jugadorx, iconox);
        salto.setVisible(true);
        this.hide();
    ...
    private void Avatar8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Avatar8ActionPerformed
        iconox = new ImageIcon("/home/labso04/Vídeos/respaldo/ParadigmasDeProgramacion/src/Media/8.png");
        JugadorO salto = new JugadorO(jugadorx, iconox);
        salto.setVisible(true);
        this.hide();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AvataresX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
